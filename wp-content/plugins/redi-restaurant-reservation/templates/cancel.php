<div id="cancel-reservation-div" style="display: none">
	...
	<div id="cancel-reservation-form">
		<form method="post" action="?jquery_fail=true">
			...
			<label for="cancelPhone-intlTel"><?php _e('Phone', 'redi-restaurant-reservation')?>:</label>
			<input type="text" value="" name="cancelPhone-intlTel" id="cancelPhone-intlTel">
			<input type="hidden" name="redi-restaurant-cancelPhone" id="redi-restaurant-cancelPhone"/>
			<label for="redi-restaurant-cancelName"><?php _e('Name', 'redi-restaurant-reservation')?>:</label>
			<input type="text" name="cancelName" id="redi-restaurant-cancelName"/>
			<label for="redi-restaurant-cancelEmail"><?php _e('Email', 'redi-restaurant-reservation')?>:</label>
